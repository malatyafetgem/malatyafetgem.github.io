...
function buildSingleExamCards(stu, examType, curExam, prevExam, stGrade){
  ...
  let card1 = `<div class="col-6 col-md-3"><div class="sec-card">
  ...
  if(prevExam){
    ...
    card2 = `<div class="col-6 col-md-3"><div class="sec-card ${cls}">
    ...
    card2 = `<div class="col-6 col-md-3"><div class="sec-card sec-neutral">
  ...
  if(perSubj.length){
    ...
    let mkSubCard = (it, isBest) => {
      ...
      return `<div class="col-6 col-md-3"><div class="sec-card ${cls}">
        <div class="sec-icon"><i class="fas ${icon}"></i></div>
        <div class="sec-body">
    ...
    let neutral = (lbl,icon) => `<div class="col-6 col-md-3"><div class="sec-card sec-neutral">
      <div class="sec-icon"><i class="fas ${icon}"></i></div>
      <div class="sec-body">
  ...
  if(aT==='student'){
    ...
    if(_aExDateRaw){
      ...
      if(sb === 'summary' || sb === ''){
        ...
        let seExtraCardsHtml = '';
        {
          ...
          if(clsTN.length >= 3 || insTN.length >= 3) {
            ...
            if(clsTN.length >= 3) {
              seExtraCardsHtml += `<div class="col-6 col-md-3"><div class="sec-card ${_clsZCls}">
                <div class="sec-icon"><i class="fas fa-chart-bar"></i></div>
            ...
            if(insTN.length >= 3) {
              seExtraCardsHtml += `<div class="col-6 col-md-3"><div class="sec-card ${_insZCls}">
          ...
          seExtraCardsHtml += `<div class="row mt-2">
            <div class="col-6 col-md-3"><div class="sec-card ${_seRateCls}">
      ...
      // ==================== TEK DERS MODU (s_matematik vb.) ====================
        ...
        let card2 = `<div class="col-6 col-md-3"><div class="sec-card ${dCls}">
        ...
        let card3 = `<div class="col-6 col-md-3"><div class="sec-card ${_fCs}">
          <div class="sec-icon"><i class="fas fa-users"></i></div>
        ...
        let card4 = `<div class="col-6 col-md-3"><div class="sec-card ${_fIs}">
          <div class="sec-icon"><i class="fas fa-school"></i></div>
      ...
      // ==================== TOPLAM NET / PUAN / SIRALAMA MODU ====================
        ...
        let card3 = `<div class="col-6 col-md-3"><div class="sec-card ${_fCs2}">
          <div class="sec-icon"><i class="fas fa-users"></i></div>
        ...
        let card4 = `<div class="col-6 col-md-3"><div class="sec-card ${_fIs2}">
          <div class="sec-icon"><i class="fas fa-school"></i></div>
    ...
    if(isRank && dDValid.length > 0) {
      ...
      perfHtml = `<div class="row mt-3 mb-2">
        <div class="col-6 col-md-3"><div class="sec-card sec-pos"><div class="sec-icon"><i class="fas fa-trophy"></i></div><div class="sec-body"><div class="sec-label">En İyi Sıra</div><div class="sec-value">${bestRank}</div><div class="sec-sub">Düşük = daha iyi</div></div></div></div>
        <div class="col-6 col-md-3"><div class="sec-card sec-neg"><div class="sec-icon"><i class="fas fa-arrow-down"></i></div><div class="sec-body"><div class="sec-label">En Kötü Sıra</div><div class="sec-value">${worstRank}</div></div></div></div>
        <div class="col-6 col-md-3"><div class="sec-card"><div class="sec-icon"><i class="fas fa-balance-scale"></i></div><div class="sec-body"><div class="sec-label">Ortalama Sıra</div><div class="sec-value">${avgRank}</div></div></div></div>
        <div class="col-6 col-md-3"><div class="sec-card"><div class="sec-icon"><i class="fas fa-percentage"></i></div><div class="sec-body"><div class="sec-label">Katılım</div><div class="sec-value">${partRate2}%</div><div class="sec-sub">${attendedCnt2}/${totalGradeExams2} Sınav</div></div></div></div>
      </div>`;
    }
    ...
    if(sortedClasses.length > 0 && allVals.length > 0) {
      ...
      if(singleExamSingleBranchHtml) {
        ...
        clsPerfHtml = `
          <div class="row mb-2">
            <div class="col-6 col-md-4 col-lg flex-fill mb-2"><div class="sec-card sec-neutral h-100"><div class="sec-icon"><i class="fas fa-users"></i></div><div class="sec-body"><div class="sec-label">Katılım Oranı</div><div class="sec-value">%${partRate}</div><div class="sec-sub">${attendedCount} / ${baseCount} Katılım</div></div></div></div>
            <div class="col-6 col-md-4 col-lg flex-fill mb-2"><div class="sec-card h-100"><div class="sec-icon"><i class="fas fa-calculator"></i></div><div class="sec-body"><div class="sec-label">Kurum Ort. (${lvlLabel})</div><div class="sec-value">${genAvgPerf.toFixed(2)}</div></div></div></div>
            <div class="col-6 col-md-4 col-lg flex-fill mb-2"><div class="sec-card h-100"><div class="sec-icon"><i class="fas fa-star"></i></div><div class="sec-body"><div class="sec-label">Ort. Üstü Sınıf</div><div class="sec-value">${aboveAvg} / ${topCls.length}</div></div></div></div>
          </div>
          <div class="row mb-3">
            <div class="col-6 col-md-4 col-lg flex-fill mb-2"><div class="sec-card sec-pos h-100"><div class="sec-icon"><i class="fas fa-trophy"></i></div><div class="sec-body"><div class="sec-label">En İyi Sınıf</div><div class="sec-value">${best.cls}</div><div class="sec-sub">Ort: ${best.avg.toFixed(2)}</div></div></div></div>
            <div class="col-6 col-md-4 col-lg flex-fill mb-2"><div class="sec-card sec-neg h-100"><div class="sec-icon"><i class="fas fa-exclamation-circle"></i></div><div class="sec-body"><div class="sec-label">En Düşük Sınıf</div><div class="sec-value">${worst.cls}</div><div class="sec-sub">Ort: ${worst.avg.toFixed(2)}</div></div></div></div>
            ${cohenHtml}
          </div>`;
      } else {
    ...
    let subjRow1Html = `<div class="row mb-2">
      <div class="col-6 col-md-4 col-lg flex-fill mb-2"><div class="sec-card h-100"><div class="sec-icon"><i class="fas fa-users"></i></div><div class="sec-body"><div class="sec-label">Toplam Kayıt</div><div class="sec-value">${ex.length} Sonuç</div></div></div></div>
      <div class="col-6 col-md-4 col-lg flex-fill mb-2"><div class="sec-card sec-neutral h-100"><div class="sec-icon"><i class="fas fa-chart-pie"></i></div><div class="sec-body"><div class="sec-label">Katılım Oranı</div><div class="sec-value">%${partRateS}</div><div class="sec-sub">${attendedCountS} / ${baseCountS} Katılım</div></div></div></div>
      <div class="col-6 col-md-4 col-lg flex-fill mb-2"><div class="sec-card h-100"><div class="sec-icon"><i class="fas fa-calculator"></i></div><div class="sec-body"><div class="sec-label">Genel Ortalama</div><div class="sec-value">${genAvg.toFixed(2)} Net</div></div></div></div>
    </div>`;
    ...
    if(!br && clsArr.length > 1) {
      subjRow2Html = `<div class="row mb-2">
        <div class="col-6 col-md-4 col-lg flex-fill mb-2"><div class="sec-card sec-pos h-100"><div class="sec-icon"><i class="fas fa-school"></i></div><div class="sec-body"><div class="sec-label">En İyi Sınıf</div><div class="sec-value">${subjBestClsObj.cls}</div><div class="sec-sub">Ort: ${subjBestClsObj.avg.toFixed(2)} Net</div></div></div></div>
        <div class="col-6 col-md-4 col-lg flex-fill mb-2"><div class="sec-card sec-neg h-100"><div class="sec-icon"><i class="fas fa-exclamation-circle"></i></div><div class="sec-body"><div class="sec-label">En Zayıf Sınıf</div><div class="sec-value">${subjWorstClsObj.cls}</div><div class="sec-sub">Ort: ${subjWorstClsObj.avg.toFixed(2)} Net</div></div></div></div>
        ${subjCohenColHtml}
      </div>`;
    }
          ...
          <div class="report-header">
            ...
            <div class="card-body report-card-body">
              ...
              <div class="row mt-2">
                  ...
                  <div class="col-6 col-md-4"><div class="sec-card sec-neutral"><div class="sec-icon"><i class="fas fa-users"></i></div><div class="sec-body"><div class="sec-label">Genel Katılım Oranı</div><div class="sec-value sec-value-compact">%${partRateGS}</div><div class="sec-sub">${attendedCountGS} / ${baseCountGS} Katılım</div></div></div></div>
              </div>
